...
import 'package:megas/src/services/common_firebase_storage_repository.dart';
...
class ChatRepository {
  ...
  deleteChat(
    ...
    /* Delete chat on receiver's side */
    await firestore
        .collection('users')
        .doc(recieverUserId)
        .collection('chats')
        .doc(auth.currentUser!.uid).delete();
/* Delete chat on current user's side */
    await firestore
        .collection('users')
        .doc(auth.currentUser!.uid)
        .collection('chats')
        .doc(recieverUserId).delete();

    // await firestore
    //     .collection('users')
    //     .doc(recieverUserId)
    //     .collection('chats')
    //     .doc(auth.currentUser!.uid).collection('messages').doc(messageId).delete(); //Todo
  }
...
// users -> reciever user id => chats -> current user id -> set data
      var recieverChatContact = ChatContact(
        ...
        profilePic: senderUserData.avatarUrl,
      ...
      var senderChatContact = ChatContact(
        ...
        profilePic: recieverUserData.avatarUrl,
