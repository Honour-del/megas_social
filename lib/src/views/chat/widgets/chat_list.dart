...
import 'package:megas/src/views/chat/widgets/my_message_card.dart';
import 'package:megas/src/views/chat/widgets/sender_message_card.dart';
...
class _ChatListState extends ConsumerState<ChatList> {
  ...
  void onLongPress(String messageId,
      recieverUserId
      ) {
    ref.read(chatControllerProvider).deleteMessage(messageId, recieverUserId);
  }
                    ...
                    showDialog<void>(
                        ...
                        builder: (context) {
                          return CupertinoAlertBox(
                            titleText: 'Wanna delete this message?',
                            del: (){
                              onLongPress(messageData.messageId, messageData.recieverid);
