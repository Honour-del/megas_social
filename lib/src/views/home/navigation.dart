              ...
              child: TabBar(
                ...
                tabs: [
                  ...
                  InkWell(
                    ...
                    const FaIcon(FontAwesomeIcons.bell, size: 30, color: Colors.white,) :
                    const FaIcon(FontAwesomeIcons.bell, size: 25, color: Colors.white54,),
                  ),
                  InkWell(
                    onTap: () {
                      setState(() {
                    ...
                    const FaIcon(FontAwesomeIcons.facebookMessenger, size: 30, color: Colors.white,) :
                    const FaIcon(FontAwesomeIcons.facebookMessenger, size: 25, color: Colors.white54,),
                  ),
                  InkWell(
                    onTap: () {
                      setState(() {
