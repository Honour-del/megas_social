...
import 'package:megas/core/utils/constants/common_functions.dart';
import 'package:megas/core/utils/constants/routes.dart';
...
class NotificationsController {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (receivedAction.actionType != ActionType.SilentBackgroundAction) {
      Fluttertoast.showToast(
          ...
          toastLength: Toast.LENGTH_SHORT,
          backgroundColor: isSilentAction ? Colors.blueAccent : MyApp.mainColor,
          gravity: ToastGravity.BOTTOM);
    }
  ...
  static Future<void> receiveStandardNotificationAction(
      ReceivedAction receivedAction) async {
    loadSingletonPage(MyApp.mainNavigatorKey
        .currentState,
