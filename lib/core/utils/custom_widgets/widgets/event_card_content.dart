...
import 'package:megas/src/views/settings/components/account_compos/compos/events/components/edit_event.dart';

import 'event_countdown.dart';

class EventCardContent extends ConsumerWidget {
          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                onPressed: () {
                  push(context, EditEvent(event: event));
                },
                child: const Text(
                  "Edit",
                  style: TextStyle(
